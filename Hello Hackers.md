##Hello Hackers
This is the first module of linux luminarium
1)Intro to commands
2)Intro to arguments
3)command history

#Intro to commands
In this challange,I need to invoke the hello command to get the flag

**Flag**
pwn.college{UC6tzSUPbbtAlVQxnGenh8ttT9U.QX3YjM1wSM3UzM0EzW}
